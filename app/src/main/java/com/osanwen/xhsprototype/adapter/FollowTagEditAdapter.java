...
public class FollowTagEditAdapter extends BaseQuickAdapter<TempData, BaseViewHolder> {

    public FollowTagEditAdapter(@Nullable List<TempData> data) {
        super(R.layout.item_follows_tag, data);
    }
    ...
    protected void convert(BaseViewHolder helper, TempData item) {
        helper.setVisible(R.id.img_cover, true);
    }
}
