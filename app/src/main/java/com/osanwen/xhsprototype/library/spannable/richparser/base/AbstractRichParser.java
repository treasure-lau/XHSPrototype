package com.osanwen.xhsprototype.library.spannable.richparser.base;
...
import com.osanwen.xhsprototype.library.spannable.VerticalImageSpan;
...
public abstract class AbstractRichParser implements IRichPaser4Local, IRichPaser4Server, IRichParseAdapter {
    ...
    public SpannableString parse2SpannableStr(final Context context, String string) {
        ...
        //覆盖最后的hashtag
        ImageSpan imageSpan = new VerticalImageSpan(context, R.drawable.bg_transparent);
